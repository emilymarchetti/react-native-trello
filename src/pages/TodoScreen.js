...
const TodoScreen = ({ navigation, route }) => {
        ...
        <ListItem bottomDivider
            ...
            rightElement={
                <View style={{ flexDirection: 'row' }}>
                    ...
                    {next && (
                        <Icon color="orange" reverse name="arrow-forward" size={18} onPress={() => updateItem(item.id)} />
                    )}
                </View>}
        />
    );
    return (
        <View style={StyleSheet.container}>
            ...
            <Icon onPress={toggleOverlay} name="add" color="green" reverse containerStyle={styles.fab} />
